      ...
      <div className="container px-4 md:px-6 relative z-10" ref={containerRef}>
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex flex-col justify-center items-center space-y-8 max-w-3xl mx-auto">
            <h1 className="stagger-item animate-fade-in text-6xl md:text-7xl lg:text-8xl font-bold text-white">
              <span className="text-blue-400">Map</span> Your Future
            </h1>
            <p className="stagger-item animate-fade-in text-xl md:text-2xl text-slate-300 max-w-[600px]">
              AI-powered career mapping that transforms ideas into success.
            </p>
