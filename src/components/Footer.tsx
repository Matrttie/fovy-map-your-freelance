      ...
      <div className="container px-4 py-12 md:px-6 md:py-16">
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
          <div className="space-y-4">
            <h3 className="text-lg font-medium text-slate-800">FOVY</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-medium text-slate-800">Product</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-medium text-slate-800">Company</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <a className="text-slate-500 hover:text-slate-900 transition-colors" href="#">
                  About
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-medium text-slate-800">Legal</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <a className="text-slate-500 hover:text-slate-900 transition-colors" href="#">
                  Privacy Policy
