    ...
    <header className={`sticky top-0 z-40 w-full transition-all duration-300 ${
      ...
      <div className="container flex h-20 items-center justify-between px-4 md:px-6">
        ...
        <div className="hidden md:flex items-center gap-4">
          <Button variant="outline" size="sm" className="h-9 rounded-xl bg-slate-800/50 backdrop-blur-sm border border-slate-700 text-slate-200 shadow-sm hover:bg-slate-700/50">
            Sign In
          </Button>
          <Button size="sm" className="h-9 bg-blue-600 hover:bg-blue-700 rounded-xl shadow-md shadow-blue-900/20">
            Get Started
          </Button>
        </div>
        <button
